...
// This will print 10 instead of the 100 we were expecting. So block "a" is shadowing the modified val of global "a" as well. In console, only b and c are in block space. a initially is in global space(a = 100), and when a = 10 line is run,

// a is not created in block space, but replaces 100 with 10 in global space itself. 
...
//  Both b's are in separate spaces (one in Block(20) and one in Script(another arbitrary mem space)(100)). Same is also true for *const* declarations.
